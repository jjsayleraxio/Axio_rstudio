...
getSampleKellyPGxCC <- function( gprobs , p = 0.2 , r = 0.5 , gaction = c( "additive" , "dominance" , "recessive" ) , alpha = 0.05 , beta = 0.8 , type = c( "main" , "interaction" ) )
{
...
getSampleKellyPGxCCVec <- function( p = 0.2 , gprobs , r = 0.5 , gaction = c( "additive" , "dominance" , "recessive" ) , alpha = 0.05 , beta = 0.8 , type = c( "main" , "interaction" ) )
{
  return( as.vector( lapply( gprobs , getSampleKellyPGxCC , p , r , gaction , alpha , beta , type ) ) )
}
