haplo.power.qt.ncp <- function( haplo , haplo.freq , base.index , haplo.beta , y.mu , y.var ) 
{
  ...
  return( list( ncp.chi.phased.haplo = ncp.chi.phase.known , ncp.f.phased.haplo = ncp.f.phase.known , ncp.chi.unphased.haplo = ncp.chi.phase.unknown , ncp.f.unphased.haplo = ncp.f.phase.unknown , df = df ) )
}
